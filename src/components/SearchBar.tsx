export const SearchBar = () => {
    return (
        <div className="sm:w-2/4 md:w-3/4 lg:w-4/5 xl:w-2/3">
            <form>
                <div className="w-full sm:w-96 flex text-gray-900 border border-gray-500 rounded-3xl p-1 pl-3 text-sm pr-2">
